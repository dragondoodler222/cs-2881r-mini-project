...
export HF_HUB_DOWNLOAD_TIMEOUT=300  # 5 minutes instead of 10 seconds
export HUGGINGFACE_HUB_TIMEOUT=300
export REQUESTS_TIMEOUT=300

# Try to use offline mode if datasets are already cached
...
SPARSITY_RATIOS=(0.01 0.02 0.03 0.04)
TYPE="unstructured"
